...
//		}
	...
	@RequestMapping( value="json/getProdName", method=RequestMethod.POST )
	public String getProdName(@RequestBody String prodName) throws Exception{
		
		String dbProduct=productService.getProdName(prodName);
